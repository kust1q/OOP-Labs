...
TEST(test_07, AddMethod) {
    money::Money m1("123");
    money::Money m2("456");
    money::Money result = m1.Add(m2);
    EXPECT_EQ(result.CheckBalance(), "5P. 79k.");
    
    money::Money m3("999");
    money::Money m4("1");
    money::Money result2 = m3.Add(m4);
    EXPECT_EQ(result2.CheckBalance(), "10P. 00k.");
    
    money::Money m5("50");
    money::Money m6("50"); 
    money::Money result3 = m5.Add(m6);
...
TEST(test_08, SubMethod) {
    money::Money m1("1000");
    money::Money m2("500");
    money::Money result = m1.Sub(m2);
    EXPECT_EQ(result.CheckBalance(), "5P. 00k.");
    
    money::Money m3("150");
    money::Money m4("75");
    money::Money result2 = m3.Sub(m4);
    EXPECT_EQ(result2.CheckBalance(), "75k.");

    money::Money m7("50");
    money::Money m8("100");
    EXPECT_THROW(m7.Sub(m8), exceptions::NegativeBalanceExceptions);
}
